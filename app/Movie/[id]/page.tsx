...
import { Calendar, Clock, Star, Play, Video, Bookmark, Globe, Building2, Youtube, Users, CirclePlay, Share2 } from "lucide-react";
...
export default async function MovieDetail({
  ...
  const [movieRes, videoRes, similarRes, imagesRes, externalRes] = await Promise.all([
    axios.get(
  ...
  const cast = movie.credits?.cast?.slice(0, 36) || [];
            ...
            <div className="flex-1 space-y-8">
              ...
              <div className="rounded-xl border bg-card text-card-foreground shadow">
                <div className="p-6">
                  ...
                  <p className="leading-7 text-muted-foreground">{movie.overview}</p>
                </div>
              </div>
