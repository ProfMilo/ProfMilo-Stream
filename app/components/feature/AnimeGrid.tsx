...
import { Star, Calendar, Clock, TrendingUp, MonitorPlay } from 'lucide-react';
            ...
            <div className="container mx-auto px-4 max-w-7xl">
                ...
                <div className="flex items-center gap-3 mb-8">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-gray-400">Anime ordered by trending</p>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6">
                    {animeList.map((anime) => (
                        <Link
                            key={anime.id}
                            href={`/tv/${anime.id}`} // Anime are usually TV shows in TMDB
