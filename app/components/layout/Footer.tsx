      ...
      <div className="p-6 lg:p-8">
        ...
        <div className="mx-10 flex flex-col gap-6 md:flex-row md:items-center md:justify-between md:gap-4">
          ...
          <div className="flex items-center gap-3 md:flex-1">
            ...
            <div>
              <h2 className="text-lg font-semibold text-foreground">ProfMilo Stream</h2>
            ...
            <div className="relative flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm leading-relaxed text-amber-800/90 dark:text-amber-200/90 md:text-base">
                  ProfMilo Stream operates as a content aggregator and does not host any media files on our servers. All content is sourced from third-party providers and embedded services. For any copyright concerns or DMCA takedown requests, please contact the respective content providers directly.
                </p>
        ...
        <div className="mt-4 text-center">
          <p className="text-xs text-muted-foreground/70">
            Built with ❤️ for entertainment by ProfMilo.
          </p>
        </div>
      </div>
    </footer>
